...
<body class="hold-transition register-page">
    <div class="register-box">
        @if ($errors->any())
            <div class="js-toast-error" data-content="{{ $errors->toJson() }}"></div>
        @endif
    ...
    <script>
        $(function() {
            if ($('.js-toast-error').length > 0) {
                var content = $('.js-toast-error').data('content');
                var bodyToast = Object.values(content).reduce((prevValue, currValue) => prevValue.append($('<li></li>').append(currValue)), $('<ul></ul>'));
                console.log(content);
